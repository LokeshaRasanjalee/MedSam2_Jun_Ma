...
from L2D_train import mao_deferral_loss_exp, onetime_deferal_loss_normalized_weights, onetime_deferal_loss_normalized_weights_0_1
...
def run_test_case(test_name, acc_no_def_batch, rejector_logits, acc_post_def_batch,alpha, beta, distance_loss, expected_behavior):
    ...
    try:
        ...
        loss = mao_deferral_loss_exp(acc_no_def_batch, rejector_logits, acc_post_def_batch,alpha, beta, distance_loss)
        ...
        selected_logit_index = infer_deferral_action (rejector_logits[0])  # Access first batch element
        ...
        print(f"Selected Logit Index: {selected_logit_index}")
...
rejector_logits_1 = torch.tensor([[2.0, 0.5, 0.4, 0.3, 0.2, 0.1, 0.0, -0.1, -0.2]])
...
rejector_logits_2 = torch.tensor([[0.5, 0.4, 0.3, 1.2, 2.0, 0.1, 0.0, -0.1, -0.2]])
...
rejector_logits_3 = torch.tensor([[0.5, 0.4, 0.3, 1.2, 0.5, 2.5, 0.0, -0.1, -0.2]])
